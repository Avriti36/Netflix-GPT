...
return ()=>unsubscribe()  //unsubscribe when component un mounts
  ...
  <button onClick={handleGPTSearch} className='mr-2 focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-[1rem] text-md px-3 py-1.5 mb-1 dark:bg-purple-900 dark:hover:bg-purple-700 dark:focus:ring-purple-900'>
    {showGptSearch?"Homepage" :"GPT Search"}
  </button>

  <div className='flex items-center gap-3 bg-gray-800 hover:bg-gray-900 text-white rounded-full px-3 py-1.5 me-2 mb-0 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700'>
